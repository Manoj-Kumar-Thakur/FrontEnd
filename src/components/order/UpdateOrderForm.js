...
export default class AddOrderForm extends React.Component {
  ...
  onUserIdChange = (e) => {
    this.setState((state) => ({
      customer: { ...state.customer, userId: e.target.value },
    }));
  };

  onProductIdChange = (e) => {
    this.setState((state) => ({
      product: { ...state.product, productId: e.target.value },
    }));
  };

  onPaymentIdChange = (e) => {
    this.setState((state) => ({
      payment: { ...state.payment, paymentId: e.target.value },
    }));
  };
          ...
          <form onSubmit={this.onSubmit}>
            ...
            <FormControl fullWidth>
              <TextField
                ...
                label="User Id"
                type="number"
                value={this.state.customer.userId}
            ...
            <Button style={style} onChange={this.onCancel}>
              {" "}
              Cancel
            </Button>
          </form>
